...
func _on_Tray_toggled(button_pressed):
	if button_pressed == true:
		$"%Tray".icon = load("res://_NokTormentHellsaint/characters/hellsaint/ui/musicplayer/musicplayer-traySHOW.png")
		$"%MusicVBoxContainer".visible = true
	
	else:
		$"%Tray".icon = load("res://_NokTormentHellsaint/characters/hellsaint/ui/musicplayer/musicplayer-trayHIDE.png")
...
func _ready():
	...
	if host.fighter:
		...
		if host.fighter.get_node("%Stuff").skin == "Camila":
			songs = $"%SongsC".get_children()
		else:
...
func _process(delta):
	if host.fighter:
		...
		if music_player_data.muted == true:
			$"%Mute".icon = load("res://_NokTormentHellsaint/characters/hellsaint/ui/musicplayer/musicplayer-musicOFF.png")
		else:
			$"%Mute".icon = load("res://_NokTormentHellsaint/characters/hellsaint/ui/musicplayer/musicplayer-musicON.png")
