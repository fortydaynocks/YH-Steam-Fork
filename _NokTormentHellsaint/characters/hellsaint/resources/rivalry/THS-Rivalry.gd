...
export (String) var rivalry_sound = "Super3"
...
export (Dictionary) var particles = {
	"spawn": [preload("res://_NokTormentHellsaint/characters/hellsaint/effects/THS_Misc2.tscn"), Vector2(0, -18)],
	"hit": [preload("res://_NokTormentHellsaint/characters/hellsaint/effects/THS_Hit3.tscn"), Vector2(20, -18)],
	"taunt": [preload("res://_NokTormentHellsaint/characters/hellsaint/effects/THS_Misc.tscn"), Vector2(0, -18)],
	"rivalry": [preload("res://_NokTormentHellsaint/characters/hellsaint/effects/THS_Super.tscn"), Vector2(0, 0)],
}
...
export (Dictionary) var quotes = {
	"Aimorrago": [
		"I do not serve you.",
		"The Influence will soon be mine.",
		"My wish will soon come true....",
	],
	"Psycho": [
		"Mason. I can easily ruin you again.",
		"You will never be free from my grasp.",
		"Over, and over, I shall desecrate your soul.",
	],
	"Colossus": [
		"You must be disciplined, Avalon.",
		"You will never surpass me.",
		"Do you truly think this is possible, Avalon?",
	],
	"Torment": [
...
export (String) var soundbyte = "RVL-Soundbyte"
