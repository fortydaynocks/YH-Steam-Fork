...
export var hp_under : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-hp-below.png")
export var hp_over : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-hp-above.png")
export var hp_progress : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-hp-bar.png")
export var hp_armor : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-hp-bararmor.png")
export var hp_projectile_armor : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-hp-barproj.png")
export var hp_trail : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-hp-bartrail.png")
export var flip_hp_for_p2 : bool = true

export var _c_Burst_Textures = 0
export var burst_under : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-burst-below.png")
export var burst_over : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-burst-above.png")
export var burst_progress : Texture = null
export var flip_burst_for_p2 : bool = true

export var _c_Super_Textures = 0
export var mini_super_under : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-super-mini-below.png")
export var mini_super_over : Texture = ImageTexture.new()
export var mini_super_progress : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-super-mini-bar-specific.png")
export var mini_super_progress2 : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-super-mini-bar-specific2.png")
export var flip_mini_super_for_p2 : bool = true

export var replay_super_under : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-super-below.png")
export var replay_super_over : Texture = ImageTexture.new()
export var replay_super_progress : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-super-bar-specific.png")
export var replay_super_progress2 : Texture = preload("res://_NokGorenShin/characters/shingoren/nokui/nokui-super-bar-specific2.png")
