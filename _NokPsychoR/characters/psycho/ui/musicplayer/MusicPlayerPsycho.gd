...
func _on_Tray_toggled(button_pressed):
	if button_pressed == true:
		$"%Tray".icon = preload("res://_NokPsychoR/characters/psycho/ui/musicplayer/musicplayer-traySHOW.png")
		$"%MusicVBoxContainer".visible = true
	
	else:
		$"%Tray".icon = preload("res://_NokPsychoR/characters/psycho/ui/musicplayer/musicplayer-trayHIDE.png")
...
func _ready():
	...
	if host.fighter:
		...
		if host.fighter.get_node("%Stuff").skin == "Guillotine":
			songs = $"%SongsG".get_children()
		else:
...
func _process(delta):
	if host.fighter:
		...
		play_music = (host.fighter.insanity == true) and host.fighter.game_over != true
		...
		if music_player_data.muted == true:
			$"%Mute".icon = load("res://_NokPsychoR/characters/psycho/ui/musicplayer/musicplayer-musicOFF.png")
		else:
			$"%Mute".icon = load("res://_NokPsychoR/characters/psycho/ui/musicplayer/musicplayer-musicON.png")
