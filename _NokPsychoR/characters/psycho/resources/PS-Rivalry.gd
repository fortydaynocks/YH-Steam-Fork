...
export (String) var rivalry_sound = "RVL-Rivalry"
...
export (Dictionary) var particles = {
	"spawn": [preload("res://_NokPsychoR/characters/psycho/effects/PsychoStar1.tscn"), Vector2(0, -18)],
	"hit": [preload("res://_NokPsychoR/characters/psycho/effects/PsychoHit2.tscn"), Vector2(20, -18)],
	"taunt": [preload("res://_NokPsychoR/characters/psycho/effects/PsychoStar1.tscn"), Vector2(0, -18)],
	"rivalry": [preload("res://_NokPsychoR/characters/psycho/effects/PsychoStarH.tscn"), Vector2(0, 0)],
}
...
export (Dictionary) var quotes = {
	...
	"Psycho": ["...?"],
	"_": ["...", "Move.", "Run.", "Get out of the way.", "I'll kill you."],
}
