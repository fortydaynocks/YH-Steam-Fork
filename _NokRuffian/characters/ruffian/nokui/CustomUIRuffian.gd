...
export var hp_under : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-hp-below.png")
export var hp_over : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-hp-above.png")
export var hp_progress : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-hp-bar.png")
export var hp_armor : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-hp-bararmor.png")
export var hp_projectile_armor : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-hp-barproj.png")
export var hp_trail : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-hp-bartrail.png")
export var flip_hp_for_p2 : bool = true

export var _c_Burst_Textures = 0
export var burst_under : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-burst-below.png")
export var burst_over : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-burst-above.png")
export var burst_progress : Texture = null
export var flip_burst_for_p2 : bool = true

export var _c_Super_Textures = 0
export var mini_super_under : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-super-mini-below.png")
export var mini_super_over : Texture = ImageTexture.new()
export var mini_super_progress : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-super-mini-bar-specific.png")
export var mini_super_progress2 : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-super-mini-bar-specific2.png")
export var flip_mini_super_for_p2 : bool = true

export var replay_super_under : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-super-below.png")
export var replay_super_over : Texture = ImageTexture.new()
export var replay_super_progress : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-super-bar-specific.png")
export var replay_super_progress2 : Texture = preload("res://_NokRuffian/characters/ruffian/nokui/nokui-super-bar-specific2.png")
...
export (Theme) var nok_font = preload("res://_NokRuffian/characters/ruffian/nokui/NokUIFontTheme.tres")
...
func _process(delta):
	if is_instance_valid(host) and not host.is_ghost:
		...
		#if host.current_tick > 0 and host.current_tick <= 10: setup_texture_replacements()
...
func setup_texture_replacements():
	...
	if is_instance_valid(ui_mini_super):
		...
		#	--	NOK EDITS
		if host.skin == 1:
			if mini_super_progress2 != null:
				atlas_mini_super_progress = create_atlas_texture(mini_super_progress2, flip_mini_super_for_p2 and host.id==2)
		else:
	...
	if is_instance_valid(ui_replay_super):
		...
		#	--	NOK EDITS
		if host.skin == 1:
			if replay_super_progress2 != null:
				atlas_replay_super_progress = create_atlas_texture(replay_super_progress2, flip_replay_super_for_p2 and host.id==2)
		else:
